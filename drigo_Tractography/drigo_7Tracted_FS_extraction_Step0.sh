...
#	1.Copy data.nii (from XX_bedpost_in )  --> nodif_brain data (current directory: XX_bedpost_out) 
#	2.Copy nodif_brain_mask.nii.gz (from XX_bedpost_in ) --> nodif_brain_mask.nii.ngz (current directory: XX_bedpost_out)
...
###STANDARD SPACE
    echo "Copying $SOURCE/../${CDIR/_out/_in}/${DIR//.bedpostX}/data.nii.gz to $DIR/nodif_brain.nii.gz "
